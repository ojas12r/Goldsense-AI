    ...
    <div style={{ paddingTop: 80, maxWidth: 920, margin: '0 auto', padding: '80px 2rem 80px' }}>
        ...
        <ScrollReveal delay={110}>
          <div className="form-card" style={{ borderColor: 'rgba(96,165,250,0.2)', marginBottom: 16 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
              ...
              }}>wav2vec2 Acoustic Analysis</div>
              <span style={{
                fontFamily: 'var(--font-mono)', fontSize: 9, color: 'var(--info)',
                background: 'rgba(96,165,250,0.08)', border: '1px solid rgba(96,165,250,0.2)',
                padding: '3px 10px', borderRadius: 100
              }}>facebook/wav2vec2-base · local</span>
            </div>
          ...
          <div className="form-card" style={{ marginBottom: 16 }}>
            ...
            {r.visual_findings.map((f, i) => (
              <div key={i} style={{
                ...
                paddingLeft: 12, borderLeft: '2px solid rgba(201,168,76,0.3)'
              }}>{f}</div>
            ))}
          </div>
        </ScrollReveal>
      ...
      <ScrollReveal delay={140}>
        <div className="form-card" style={{ marginBottom: 24 }}>
          ...
          <div style={{
            marginTop: 14, borderLeft: '2px solid var(--gold-dim)',
